...
def get_region_and_city(latitude, longitude):
    """
    Retrieves the administrative area level 1 (region) and city for a given latitude and longitude using the Google Maps Geocoding API.
    ...
    Returns:
        tuple: A tuple containing the administrative area level 1 (region) name and city for the given latitude and longitude.
               If no region or city is found, returns ('Unknown', 'Unknown').
    """
    ...
    # Initialize region and city variables
    region_name = 'Unknown'
    city_name = 'Unknown'
    
    # Iterate through the reverse geocode results to find the administrative area level 1 (region) and city
    ...
    if region_name in region_mapping:
        major_region = region_mapping[region_name]
    else:
        major_region = 'Unknown'
    
    return major_region, city_name
